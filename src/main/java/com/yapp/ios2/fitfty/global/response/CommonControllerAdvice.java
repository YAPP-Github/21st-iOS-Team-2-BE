...
import com.yapp.ios2.fitfty.global.exception.ForbiddenException;
import com.yapp.ios2.fitfty.global.exception.UnauthorizedException;
...
public class CommonControllerAdvice {
    ...
    /**
     * http status: 401 AND result: FAIL UnAuthorized 에러
     *
     * @param e
     * @return
     */
    ...
    public CommonResponse UnauthorizedException(UnauthorizedException e) {
        String eventId = MDC.get(CommonHttpRequestInterceptor.HEADER_REQUEST_UUID_KEY);
        log.error("eventId = {} ", eventId, e);

        return CommonResponse.fail(ErrorCode.UNAUTHORIZED.getErrorMsg(),
